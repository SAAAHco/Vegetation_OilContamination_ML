...
class StudyAreaConfig:
    ...
    name: str = "Southern Greater Burgan Oil Field, Kuwait (SKETR-II polygon)"  # e.g., "Greater_Burgan_Oil_Field"
    latitude: float = 28.87  # Center latitude (decimal degrees)
    longitude: float = 47.95  # Center longitude (decimal degrees)
    area_km2: float = 93.6  # Total study area in km²
    
    # Coordinate system [CUSTOMIZE]
    crs_epsg: int = 32638  # UTM Zone - select appropriate for your region
...
class SatelliteConfig:
    ...
    sensor_name: str = "Sentinel-2"  # Options: "Landsat-8", "Landsat-9", "Sentinel-2", "Custom"
    spatial_resolution_m: float = 10.0  # Native pixel size in meters
